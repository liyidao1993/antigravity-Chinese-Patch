...
function getLocalizationScript() {
  ...
  const T = {
    ...
    "Application": "应用程序",
    "Controls the actions the agent can take.": "控制 Agent 可以执行的操作。",
    "Whether the agent asks you to review its documents.": "Agent 是否会请求您审核其创建的文档。",
    "Also includes": "还包括",
    "when working in this project.": "在此项目中工作时。",
    "Configure agent execution, queued message delivery, and permissions.": "配置 Agent 执行、排队消息发送以及权限。",
    "Execution": "执行",
    ...
    "Wide": "宽",
    "Tab": "Tab 键",
    "Configure tab completion, suggestions, and navigation behavior.": "配置 Tab 键补全、建议与导航行为。",
    "Browser settings have moved": "浏览器设置已迁移",
    "Browser settings have moved to the Browser section of General settings.": "浏览器设置已移至常规设置中的“浏览器”板块。",
    "Go to General settings": "前往常规设置",
    "Jetski Chat": "Jetski 聊天",
    "Configure a chat bot so you can use Jetski directly from Google Chat.": "配置聊天机器人，以便直接从 Google Chat 中使用 Jetski。",
    ...
    "Keep the app accessible from the menu bar and running in the background when all windows are closed.": "在所有窗口关闭时，保持应用可从菜单栏访问并在后台继续运行。",
    "Version": "版本",
    "App version": "应用版本",
    "Advanced Settings": "高级设置",
    "Remote Control Issue": "远程控制问题",
    "Please describe the issue in detail. The more actionable your feedback, the quicker our team can address your request. Some helpful information includes:": "请详细描述该问题。您的反馈越具体，我们的团队就能越快处理您的请求。建议包含的信息：",
    ...
    "Labs": "实验室",
    "Try out early-stage features before they ship. These may change or be removed at any time.": "抢先体验尚未正式发布的早期功能。这些功能可能随时变动或移除。",
    "Experimental features": "实验性功能",
    "Conversation Sharing": "对话分享",
    "Generate a link that lets any Googler load a read-only copy of a conversation. Sharing exports the conversation history to your public x20 folder, so it needs that folder to be readable by others.": "生成链接以供加载对话的只读副本。分享时会将对话历史导出至公开目录。",
    "Inline Actions": "内联操作",
    "Show a floating notification card when background conversations need your input. Answer questions, approve commands, and grant permissions without leaving your current conversation. Share feedback at go/inline-actions-feedback.": "当后台对话需要您的输入时显示浮动通知卡片。无需离开当前对话即可回答问题、批准命令与授权。",
    "CitC Settings": "CitC 设置",
    "Manage settings specific to Google CitC workspaces development.": "管理特定于 Google CitC 工作区开发的设置。",
    "Best of N": "Best of N",
    "Manage how Best of N sets up the workspaces its arms run in.": "管理 Best of N 如何配置其分支运行所在的工作区。",
    "Models & Usage": "模型与用量",
    "Manage your model quota and credits.": "管理您的模型配额与额度。",
    "Developer": "开发者",
    "Developer-only tools. These settings are stored locally in this browser and do not affect other users.": "仅供开发者使用的工具。这些设置保存在本地浏览器中，不影响其他用户。",
    "Regroup Google3 Chats": "重新聚合 Google3 聊天",
    "Google3 chats will be regrouped into their workspaces in the sidebar.": "Google3 聊天将重新归类到侧边栏的工作区中。",
    "This migration may mess up your settings, chats, and sidebar.": "此迁移可能会影响您的设置、聊天与侧边栏。",
    "Remote Control": "远程控制",
    "Enable Remote Control": "启用远程控制",
    "Work with local agents from another device.": "从另一台设备与本地 Agent 协同工作。",
    "Device Name": "设备名称",
    "A label for this computer when you connect from another device. Changing it reconnects.": "从其他设备连接此计算机时显示的设备标识。修改后将重新连接。",
    "Scan the code to open this device in Remote Control, or": "扫描二维码以在远程控制中打开此设备，或",
    "copy link": "复制链接",
    "Manage project folders, agent settings, and permissions.": "管理项目文件夹、Agent 设置与权限。",
    "Skills": "技能",
    "Rules": "规则",
    "Mcp Tools": "MCP 工具",
    "Core tools and knowledge required to develop for Android": "开发 Android 所需的核心工具与知识",
    "Reliable automation, in-depth debugging, and performance analysis in Chrome using Chrome DevTools and Puppeteer": "使用 Chrome DevTools 与 Puppeteer 在 Chrome 中实现可靠的自动化、深度调试与性能分析",
    "Using the Google Antigravity Python SDK to build AI agents": "使用 Google Antigravity Python SDK 构建 AI Agent",
    "Curated collection of agent skills for modern web development.": "精选的现代 Web 开发 Agent 技能集合。",
    "Curated collection of agent skills for science tasks.": "精选的科学任务 Agent 技能集合。",
  };
  ...
  const RE = [
    ...
    // ---- v2.12.2 动态正则 ----
    [/^Mark all (\\d+) conversations as read$/, (m) => '将全部 ' + m[1] + ' 个对话标记为已读'],
    [/^You have used some of your 5-hour limit, it will fully refresh in (.+)\\.$/, (m) => '您已使用了部分 5 小时限额，将在 ' + m[1].replace(/hours?/g, '小时').replace(/minutes?/g, '分钟') + ' 后完全刷新。'],
    [/^Show (\\d+) breakdowns?$/, (m) => '显示 ' + m[1] + ' 个用量明细'],
    [/^(\\d+) tools enabled$/, (m) => m[1] + ' 个工具已启用'],
    [/^(\\d+) active conversations?$/, (m) => m[1] + ' 个活跃对话'],
    [/^Thought for (\\d+)s$/, (m) => '已思考 ' + m[1] + ' 秒']
  ];
